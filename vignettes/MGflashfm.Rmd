...
mgmtCS <- MGFLASHFMwithJAM(gwas.list=gwas.list, LD.list=corX.list, covY.list=covY.list, Nall=Nall, multi=TRUE, TOdds=1, maxcv=1, 
	maxcv_stop = 20, save.path=save.path, cpp=0.99, cred=0.99,NCORES=1,jam.nM.iter=5,r2=.8,flashfmRET=TRUE, extra.java.arguments=NULL) 
# which, using the default settings, is equivalent to
mgmtCS <- MGFLASHFMwithJAM(gwas.list=gwas.list, LD.list=corX.list, covY.list=covY.list, Nall=Nall, save.path=save.path,    flashfmRET=TRUE)
``` 
...
mgCS1 <- MGFMwithJAM(gwas.list=T1gwas.list, corX.list=corX.list,  Nall=N1all, save.path=save.path, cpp=0.99, cred=0.99, maxcv=1, maxcv_stop = 20, NCORES=1, jam.nM.iter=5, r2=0.8, extra.java.arguments=NULL)
# using defaults:
mgCS1 <- MGFMwithJAM(gwas.list=T1gwas.list, corX.list=corX.list,  Nall=N1all, save.path=save.path)
``` 
...
g2t1CS <- JAMdynamic(gwas=gwas.list[[2]][[1]],corX=corX.list[[2]], ybar=0, Vy=1, N=Nall[[2]][1], cred=.99, save.path="tmpDIR", 
	maxcv=1, maxcv_stop = 20, jam.nM.iter=5, r2=0.8, extra.java.arguments=NULL)
...
mtg1 <- FLASHFMwithJAMd(gwas.list=gwas.list[[1]], corX=corX.list[[1]], ybar=c(0,0), N=Nall[[1]], save.path=save.path, TOdds = 1, covY=covY.list[[1]], cpp = 0.99, NCORES=1, maxcv=1, maxcv_stop = 20,jam.nM.iter=5, r2=0.8, extra.java.arguments=NULL)  
mtg1CS <- allcredsetsPP(mtg1$mpp.pp,cred=.99)      
#' Group 2 multi-trait fine-mapping with flashfm using default settings
 mtg2 <- FLASHFMwithJAMd(gwas.list=gwas.list[[2]], corX=corX.list[[2]], ybar=c(0,0), N=Nall[[2]], save.path=save.path, covY=covY.list[[2]])  
